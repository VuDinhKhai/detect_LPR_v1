...
from LPR.utils.dataloaders import exif_transpose, letterbox
from LPR.utils.general import (LOGGER, check_requirements, check_suffix, check_version, colorstr, increment_path,
...
from LPR.utils.torch_utils import copy_attr, time_sync
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from LPR.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
