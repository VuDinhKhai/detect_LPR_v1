...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_listxe = CheckableComboBox()
        self.comboBox_listxe.setMaximumSize(QtCore.QSize(16777215, 60))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt;\">Nhập biển số xe cần nhận diện , chọn danh sách quản lý xe</span></p></body></html>"))
